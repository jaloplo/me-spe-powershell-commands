...
- SharePoint Embedded files recycle management:
  - **Add-SPEFile**: Uploads a file to a container.
  - **Get-SPEFile**: Retrieve a list of files in the specified container.
  - **Remove-SPEFile**: Deletes a file from a container.
